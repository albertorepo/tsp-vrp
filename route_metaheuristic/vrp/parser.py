...
class InstanceParser:
    ...
    def retrieve_instance(self):
        ...
        self.x_coord = [None] * number_of_nodes
        self.y_coord = [None] * number_of_nodes
        ...
        warehouse_id = int(file_iter.next())
        if warehouse_id != 1:
            raise AttributeError('Warehouse ID is supossed to be 1')

        end_of_depot_section = int(file_iter.next())
        ...
        return truck_capacity, distance_matrix, demand
